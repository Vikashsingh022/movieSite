  ...
  if (!movie) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-white text-black dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800 dark:text-white">
        <h2 className="text-4xl mb-4">Movie not found</h2>
        <Link to="/" className="text-indigo-600 dark:text-indigo-400 underline text-2xl">Back to Home</Link>
      </div>
    );
  }

  return (
    <div className="min-h-screen bg-white text-black dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800 dark:text-white flex flex-col items-center py-12 px-2 md:px-8">
      <div className="w-full max-w-4xl bg-gray-100 dark:bg-gray-900 rounded-2xl shadow-2xl flex flex-col md:flex-row overflow-hidden">
        ...
        <div className="md:w-1/2 w-full flex flex-col p-8 gap-4">
          ...
          <p className="text-gray-700 dark:text-gray-200 text-lg mb-2">{movie.overview}</p>
          ...
          <Link to="/" className="mt-6 inline-block text-indigo-600 dark:text-indigo-400 underline text-xl">← Back to Home</Link>
        </div>
      </div>
    </div>
  );
